...
public class hshaik24_lab04_q3 
{
	public static void main(String[] args) 
	{
			...
			{	
				...
				determineOption(choice, difficulty);
				
			}
		}	
		public static void determineOption(int choice, int difficulty) 
		{
			Scanner input = new Scanner(System.in);
			if(choice == 1) 
			{		
			...
			else if(choice ==5) 
			{
				...
				determineOption(newChoice, newDifficulty);
			}
			else if(choice == 6) 
			{
					System.exit(0);
